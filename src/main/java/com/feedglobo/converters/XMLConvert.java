...
public class XMLConvert implements IXMLConvert {
	...
	/**
	 * Recebe o XML em forma de String e retira de dentro dele a lista 
	 * de itens já em formato de JSONArray
	 */
	...
	/**
	 * Recebe uma url e retorna um String com o seu conteúdo.
	 * Nesse projet é o proprio XML do feed de origem de dados.
	 */
	...
	/**
	 * Recebe um JSONArray com os itens do XML de origem de dados 
	 * e converte para um JSONArray de itens no formato de saída 
	 */
	public JSONArray converteItemsToFeedItem(JSONArray itens) {
    	...
    	//Para item na lista de itens original ele vai criar um novo item na lista de saída 
    	for (int i = 0; i < itens.length(); i++) {
        	...
        	for (Element paragrafo : paragrafos) {
        		...
        		//Optei por retirar por causa do exemplo de saída de json dado no Git do desafio.
        	...
        	//Após a lista de links montada ela é incluída dentro de um nó links do json de saída
    		JSONObject ljson = new JSONObject();
    		ljson.put("type", "links");
    		ljson.put("content", listalinks);
    		
    		// o novo item (ljson) está pronto e é incluindo como um item da lista description 
        	...
        	//Criando um nó item e incluindo os objetos gerados acima, formando assim a estrutura 
